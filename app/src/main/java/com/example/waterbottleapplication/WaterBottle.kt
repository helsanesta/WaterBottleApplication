...
fun WaterBottle(
    ...
    //    Use canvas composable to draw UI custom shape
    //    - for make a bottle
    Box(
        modifier = modifier
            .width(200.dp)
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            val bottleBodyPath = Path().apply {
                ...
                //   For making a line in canvas
                lineTo(width * 0.3f, height * 0.2f)

                //   For making a curve in canvas
                quadraticBezierTo(
            ...
            // Function that basically cut off anything in viewer shape
            clipPath(
                path = bottleBodyPath
            ){
                ...
                // Draw the water waves from the bottom
